    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(600px circle at var(--mouse-x, 0px) var(--mouse-y, 0px), rgba(109, 93, 246, 0.07), transparent 40%)',
          }}
        />
      </div>
      ...
      <div className="w-full lg:w-[60%] flex flex-col justify-between p-8 lg:p-14 z-10 border-b lg:border-b-0 lg:border-r border-white/[0.04] relative">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[9px] font-bold tracking-widest text-[#5B7CFF] uppercase block -mt-0.5">
                AI Operating System
              </span>
            </div>
          </div>
        ...
        <div className="my-12 lg:my-0 space-y-8 max-w-xl text-left">
          <h1 className="text-4xl md:text-5xl lg:text-5.5xl font-extrabold tracking-tight text-white leading-[1.08]">
            Your inbox should{' '}
            <span className="bg-gradient-to-r from-[#6D5DF6] via-[#5B7CFF] to-cyan-400 bg-clip-text text-transparent">
              think before you do.
            </span>
          </h1>
              ...
              {[
                {
                  ...
                  icon: <Inbox size={14} />,
                  label: 'Ingest',
                  val: 'Parsing raw header...',
                },
                {
                  step: 1,
                  icon: <Cpu size={14} />,
                  label: 'AI Analyze',
                  val: 'Priority: 94% Urgent',
                },
                {
                  step: 2,
                  icon: <Zap size={14} />,
                  label: 'Rules DSL',
                  val: 'Trigger: Outage Rule',
                },
                {
                  step: 3,
                  icon: <Send size={14} />,
                  label: 'Action Dispatch',
                  val: 'Dispatched slack payload',
                },
              ].map((node) => (
                <div
                  key={node.step}
