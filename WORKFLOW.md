...
1. **Start Feature:** Create a new branch off of `develop`:
   ...
   ```
2. **Commit Changes:** Work on your code locally, following the commit guidelines in our [CONTRIBUTING.md](file:///c:/Users/ravi/Desktop/INBOX/InboxOS/CONTRIBUTING.md).
